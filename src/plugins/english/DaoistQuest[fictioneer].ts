import { CheerioAPI, load as loadCheerio, load } from 'npm:cheerio';
...
const plugin = new FictioneerPlugin({"id":"daoistquest","sourceSite":"https://daoist.quest","sourceName":"Daoist Quest","options":{"browsePage":"collection/novels","versionIncrements":1}});
