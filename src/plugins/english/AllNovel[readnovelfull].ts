import { CheerioAPI, load as parseHTML, load } from 'npm:cheerio';
...
const plugin = new ReadNovelFullPlugin({"id":"allnovel","sourceSite":"https://allnovel.org","sourceName":"AllNovel","options":{"popularPage":"most-popular?page=%%PAGE%%","latestPage":"latest-release-novel?page=%%PAGE%%","searchPage":"search?keyword=%%SEARCH%%&page=%%PAGE%%"}});
