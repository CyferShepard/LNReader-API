...
const plugin = new ReadNovelFullPlugin({"id":"lightnovelplus","sourceSite":"https://lightnovelplus.com","sourceName":"LightNovelPlus","options":{"popularPage":"book/bookclass.html?type=hot_novel&language=en&page_num=%%PAGE%%","latestPage":"book/bookclass.html?type=last_release&language=en&page_num=%%PAGE%%","searchPage":"book/search.html?keyword=%%SEARCH%%&page_num=%%PAGE%%&language=en"}});
