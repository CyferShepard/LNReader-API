...
const plugin = new LightNovelWPPlugin({"id":"kolnovel","sourceSite":"https://kolnovel.org/","sourceName":"Kol Novel","options":{"lang":"Arabic","reverseChapters":true,"customJs":"$('article > style').text().match(/\\.\\w+(?=\\s*[,{])/g)?.forEach(tag => $(`p${tag}`).remove());$('.epcontent .code-block').remove();","versionIncrements":6},"filters":{"genre[]":{"type":"Checkbox","label":"تصنيف","value":[],"options":[{"label":"Romance","value":"romance"},{"label":"Shounen Ai","value":"shounen-ai"},{"label":"Wuxia","value":"wuxia"},{"label":"Xianxia","value":"xianxia"},{"label":"XUANHUAN","value":"xuanhuan"},{"label":"أبطال خارقين","value":"أبطال-خارقين"},{"label":"أكشن","value":"action"},{"label":"ألعاب","value":"ألعاب"},{"label":"إثارة","value":"excitement"},{"label":"إسلامي","value":"إسلامي"},{"label":"إنتقال الى عالم أخر","value":"isekai"},{"label":"إيتشي","value":"etchi"},{"label":"اكاديمي","value":"اكاديمي"},{"label":"اكشن","value":"اكشن"},{"label":"الخيال العلمي","value":"sci-fi"},{"label":"انتقام","value":"انتقام"},{"label":"بطل مضاد","value":"بطل-مضاد"},{"label":"بناء مملكة","value":"بناء-مملكة"},{"label":"بوليسي","value":"policy"},{"label":"تاريخ","value":"تاريخ"},{"label":"تاريخي","value":"historical"},{"label":"تحقيقات","value":"تحقيق"},{"label":"تشويق","value":"تشويق"},{"label":"تقمص شخصيات","value":"rpg"},{"label":"تلاعب","value":"تلاعب"},{"label":"تناسخ","value":"تناسخ"},{"label":"جريمة","value":"crime"},{"label":"جوسى","value":"josei"},{"label":"جوسي","value":"جوسي"},{"label":"حريم","value":"harem"},{"label":"حياة مدرسية","value":"school-life"},{"label":"خارق للطبيعة","value":"خارق-للطبيعة"},{"label":"خيال","value":"خيال"},{"label":"خيال علمي","value":"خيال-علمي"},{"label":"خيالي","value":"خيالي"},{"label":"خيالي(فانتازيا)","value":"fantasy"},{"label":"دراما","value":"drama"},{"label":"درامي","value":"درامي"},{"label":"رعب","value":"horror"},{"label":"رعب كوني","value":"رعب-كوني"},{"label":"رعب نفسي","value":"رعب-نفسي"},{"label":"رومانسي","value":"romantic"},{"label":"رومنسية","value":"رومنسية"},{"label":"زيانشيا","value":"زيانشيا"},{"label":"ستيم بانك","value":"ستيم-بانك"},{"label":"سحر","value":"magic"},{"label":"سفر عبر الزمن","value":"سفر-عبر-الزمن"},{"label":"سياسة","value":"سياسة"},{"label":"سينن","value":"senen"},{"label":"شريحة من الحياة","value":"slice-of-life"},{"label":"شوجو","value":"shojo"},{"label":"شونين","value":"shonen"},{"label":"طبي","value":"medical"},{"label":"ظواهر خارقة للطبيعة","value":"supernatural"},{"label":"عائلي","value":"عائلي"},{"label":"غموض","value":"mysteries"},{"label":"فانتازي","value":"فانتازي"},{"label":"فانتازيا","value":"فانتازيا"},{"label":"فنتازيا","value":"فنتازيا"},{"label":"فنون القتال","value":"martial-arts"},{"label":"قصة قصيرة","value":"قصة-قصيرة"},{"label":"قوة خارقة","value":"قوة-خارقة"},{"label":"قوى خارقة","value":"superpower"},{"label":"كوميدي","value":"comedy"},{"label":"كوميديا","value":"كوميديا"},{"label":"كوميدية","value":"كوميدية"},{"label":"مأساوي","value":"tragedy"},{"label":"مؤامرة","value":"مؤامرة"},{"label":"ما بعد الكارثة","value":"after-the-disaster"},{"label":"ما بعد نهاية العالم","value":"ما-بعد-نهاية-العالم"},{"label":"مضاد البطل","value":"مضاد-البطل"},{"label":"مغامرة","value":"adventure"},{"label":"ميكا","value":"mechanical"},{"label":"ناضج","value":"mature"},{"label":"نظام","value":"نظام"},{"label":"نفسي","value":"psychological"},{"label":"ون شوت","value":"ون-شوت"},{"label":"ووكسيا","value":"ووكسيا"}]},"type[]":{"type":"Checkbox","label":"النوع","value":[],"options":[{"label":"إنجليزية","value":"english"},{"label":"رواية لايت","value":"light-novel"},{"label":"رواية مؤلفة","value":"رواية-مؤلفة"},{"label":"رواية ويب","value":"web-novel"},{"label":"صينية","value":"chinese"},{"label":"عربية","value":"arabic"},{"label":"كورية","value":"korean"},{"label":"مؤلفة","value":"مؤلفة"},{"label":"ون شوت","value":"ون-شوت"},{"label":"يابانية","value":"japanese"}]},"status":{"type":"Picker","label":"الحالة","value":"","options":[{"label":"الكل","value":""},{"label":"Ongoing","value":"ongoing"},{"label":"Hiatus","value":"hiatus"},{"label":"Completed","value":"completed"}]},"order":{"type":"Picker","label":"ترتيب حسب","value":"","options":[{"label":"الإعداد الأولي","value":""},{"label":"A-Z","value":"title"},{"label":"Z-A","value":"titlereverse"},{"label":"أخر التحديثات","value":"update"},{"label":"أخر ما تم إضافته","value":"latest"},{"label":"الرائجة","value":"popular"},{"label":"التقييم","value":"rating"}]}}});
