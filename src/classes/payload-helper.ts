...
// import { FieldOptions, FilterType, SourceFilterField } from "../models/source_filter.ts";
import { ScraperPayload } from "./api-parser.ts";

let PLUGINS: Record<string, unknown>[] | Source[] = []; // This will hold the loaded plugins
